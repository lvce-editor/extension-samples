...
export const samples: readonly Sample[] = [
  ...
  },
  {
    ...
    preview: { entry: '/example.settings', files: { '/example.settings': 'color=TODO\nsize=TODO\n' } },
  ...
  },
  {
    ...
    preview: { entry: '/example.settings', files: { '/example.settings': 'color=\n' } },
  ...
  },
  {
    ...
    preview: { entry: '/example.settings', files: { '/example.settings': 'blue green red unknown\n' } },
  ...
  },
  {
    ...
    preview: { entry: '/example.settings', files: { '/example.settings': '  color=blue  \nsize =large\n' } },
