...
Open [the playground](https://lvce-editor.github.io/extension-samples/formatting-provider/). Focus the preview editor and right-click the document and choose **Format Document**. Leading/trailing whitespace is removed and each equals sign gets one space on each side. Formatting an already formatted document returns no edits.
