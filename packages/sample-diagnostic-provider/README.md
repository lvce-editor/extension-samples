...
Open [the playground](https://lvce-editor.github.io/extension-samples/diagnostic-provider/). The preview opens `example.txt` with two TODO markers. Both have error underlines. Replace TODO with a value to clear its diagnostic; add another TODO to create a new diagnostic. Positions are zero-based rows and columns.
